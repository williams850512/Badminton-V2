    ...
    <div class="form-container">
        ...
        <form action="${pageContext.request.contextPath}/VenuesServlet?action=insert" method="post">
            ...
            <div class="form-group" style="margin-bottom: 15px;">
                ...
                <input type="text" name="venueName" class="form-control" style="width: 300px;" required>
            </div>
            
            <div class="form-group" style="margin-bottom: 15px;">
                <label style="display: inline-block; width: 100px;">球館地址：</label>
                <input type="text" name="address" class="form-control" style="width: 300px;" required>
            </div>

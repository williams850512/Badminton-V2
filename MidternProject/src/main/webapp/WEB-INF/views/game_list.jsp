...
<head>
    ...
    <style>
        ...
        .game-item { 
            ...
            padding: 20px; border-bottom: 1px solid #eee; transition: 0.3s; 
        }
...
<div class="list-container">
    ...
    <c:forEach var="game" items="${allGames}">
        <div class="game-item">
            ...
            <a href="${pageContext.request.contextPath}/JoinGameServlet?gameId=${game.gameId}" class="btn-join">我要報名</a>
        </div>
    </c:forEach>

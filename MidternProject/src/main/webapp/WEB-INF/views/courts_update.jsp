    ...
    <div class="app-container">
        ...
        <div class="main-content">
            ...
            <div class="content-body">
                <h2 style="margin-bottom: 20px; color: #333;">修改場地</h2>
    ...
    <div class="form-container">
        ...
        <form action="${pageContext.request.contextPath}/CourtsServlet?action=update" method="post">
            ...
            <div class="form-group" style="margin-bottom: 15px;">
                ...
                <input type="text" name="courtName" value="${court.courtName}" class="form-control" style="width: 300px;" required>
            </div>
            ...
            <a href="${pageContext.request.contextPath}/CourtsServlet?venueId=${court.venueId}" class="btn btn-warning" style="margin-left: 10px;">返回列表</a>
        </form>
    </div>
 			</div>
			</div>
